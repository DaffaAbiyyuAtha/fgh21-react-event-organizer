...
import { FaCirclePlus, FaBook, FaHeart, FaGear, FaRightFromBracket, FaBars } from "react-icons/fa6";
...
function Sidebar() {
  ...
  return (
    <div className="md:flex flex-col md:p-6">
      ...
      <div className="flex gap-[24px] hover:text-[#468585] items-center text-[#468585] md:text-[#DEF9C4] tracking-[1px] font-semibold mb-[28px]">
        <div className="">
          <FaUser />
        </div>
        <div className="">Profile</div>
      </div>
      <div className="flex gap-[24px] text-[#468585] md:text-[#DEF9C4] hover:text-[#468585] items-center tracking-[1px] font-semibold mb-[28px] pl-[50px]">
        <div className="">
          <FaAddressCard />
        </div>
      ...
      <Link to="/profile" className="">
        <div className="flex gap-[24px] hover:text-[#468585] text-[#468585] md:text-[#DEF9C4] items-center tracking-[1px] font-semibold mb-[28px] pl-[50px]">
          <div className="">
            <FaPen />
          </div>
      ...
      <Link to="/change-password">
        <div className="flex hover:text-[#468585] items-center gap-[24px] text-[#468585] md:text-[#DEF9C4] tracking-[1px] font-semibold mb-[28px] pl-[50px]">
          <div className="">
            <FaLockOpen />
          </div>
